    ...
    const products = {
        ...
        10: {
          ...
          function removeFromCart(index) {
            cartItems.splice(index, 1); // Elimina el producto del array
          ...
          function openModal(productId) {
            ...
            product.images.forEach((image, index) => {
              const isActive = index === 0 ? 'active' : '';  // La primera imagen será la activa
              const carouselItem = `
            ...
            sizeSelect.innerHTML = ""; // Limpia las tallas anteriores
            ...
            document.getElementById("addToCartBtn").onclick = () => {
              ...
              const itemDescription = selectedSize ? `${product.name} - Size ${selectedSize}` : product.name;
          ...
          // Asignar eventos a los productos destacados
